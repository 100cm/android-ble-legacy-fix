...
class BluetoothScannerImplLollipop extends BleScannerCompat {
    ...
    public void startScan(ScanWrapperCallback scanWrapperCallback) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            Log.d("bluetoothAdapter", String.valueOf(bluetoothAdapter.isLeExtendedAdvertisingSupported()));
        }
        setScanSettings();
    ...
    private void setScanSettings() {
        ...
        ScanSettings.Builder scanBuild = new ScanSettings.Builder();
        if (background){
            ...
            if (filter == null){
                filters.add(new ScanFilter.Builder()
                   ...
                   scanBuild.setScanMode(ScanSettings.SCAN_MODE_LOW_POWER);
            ...
            scanBuild.setScanMode(ScanSettings.SCAN_MODE_LOW_LATENCY);

        }
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            scanBuild.setLegacy(false);
        }
        scanSettings = scanBuild.build();
